...
const stats = [
  { title: "TOTAL VEHICLES", value: "142", icon: Bike, color: "#A53200" },
  { title: "ACTIVE DRIVERS", value: "128", icon: Users, color: "#A53200" },
  { title: "AVAILABLE REQUESTS", value: "13", icon: ClipboardList, color: "#A53200" },
];
      ...
      <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-4 sm:gap-6 mt-6 sm:mt-10">
        <div className="space-y-3 flex-1 max-w-4xl">
          <div className="relative group w-full">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-[#A53200] transition-colors" />
            <Input
              placeholder="Search anything..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="pl-12 h-12 sm:h-14 bg-white/50 border-none rounded-sm text-gray-700 placeholder:text-gray-400 focus-visible:ring-1 focus-visible:ring-[#A53200]/20 transition-all font-normal"
            />
          </div>
        ...
        <div className="flex items-center">
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 cursor-pointer bg-[#A53200] text-white rounded-lg text-sm font-medium shadow-lg shadow-orange-100 hover:bg-[#0085C4] transition-all"
          >
            Add Vehicles
          </button>
        </div>
                        ...
                        {menuOpenId === item.id && (
                          <>
                            ...
                            >
                              ...
                              >
                                <Eye className="w-4 h-4 text-gray-400 group-hover:text-[#A53200]" />
                                View Profile
                              </button>
                              ...
                              {activeTab === "active" ? (
                                ...
                                <>
                                  ...
                                  <button className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-[#A53200] hover:bg-orange-50 rounded-lg cursor-pointer transition-colors group border-t border-gray-50 mt-1">
                                    <X className="w-4 h-4" />
                                    Reject Driver
                                  </button>
                                </>
          ...
          {[1, 2, 3, 4, 5, 6, "...", 10].map((page, i) => (
            <button
              ...
              className={cn(
                ...
                page === 1 ? "bg-[#A53200] text-white shadow-lg shadow-orange-100" : "bg-white text-gray-600 hover:bg-gray-50 border border-gray-100 shadow-sm"
              )}
            >
              {page}
            </button>
          ...
          {[1, 2, 3, "...", 10].map((page, i) => (
            <button
              ...
              className={cn(
                ...
                page === 1 ? "bg-[#A53200] text-white shadow-md shadow-orange-100" : "bg-white text-gray-600 border border-gray-100"
              )}
            >
              {page}
            </button>
              ...
              <div className="p-6 sm:p-10 space-y-6 sm:space-y-8">
                  ...
                  >
                    ...
                    {vehicleForm.imagePreview ? (
                      ...
                      <div className="w-16 h-16 rounded-full bg-orange-100 flex items-center justify-center">
                        <Camera className="w-7 h-7 text-[#A53200]" />
                      </div>
                    )}
                  ...
                  <div className="flex-1 space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full h-14 px-4 bg-[#EDE8DF] mt-1 border-none rounded-xl text-base text-gray-800 placeholder:text-gray-400 focus:ring-1 focus:ring-[#A53200]/20 outline-none resize-none placeholder:text-gray-400"
                      />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full h-12 px-4 bg-[#EDE8DF] mt-1 border-none rounded-xl text-base text-gray-800 placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-[#A53200]/20 transition-all"
                        />
                      </div>
                      ...
                      <div className="space-y-1.5">
                        ...
                        >
                          <SelectTrigger
                            className="w-full h-12 mt-1 px-4 bg-[#EDE8DF] py-6 border-none rounded-lg text-base text-gray-800 focus:ring-1 focus:ring-[#A53200]/30 cursor-pointer"
                          >
                ...
                <div className="flex items-center justify-end gap-4 sm:gap-8 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none sm:px-16 h-12 bg-[#A53200] hover:bg-[#0085C4] text-white rounded-xl text-base font-medium shadow-lg shadow-orange-200 transition-all active:scale-95 cursor-pointer"
                  >
                    Add
                  </button>
                </div>
