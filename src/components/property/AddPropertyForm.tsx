...
const inputCls =
  "h-11 rounded-lg border text-sm px-4 focus-visible:ring-1 focus-visible:ring-[#A53200] focus-visible:border-[#A53200]";
    ...
    <div className="w-full flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 space-y-6">
        ...
        <Section title="Basic Information" delay={0.05}>
          ...
          <Field label="Description">
            <Textarea
              className="rounded-sm border text-sm px-4 py-3 min-h-[100px] resize-none focus-visible:ring-1 focus-visible:ring-[#A53200] focus-visible:border-[#A53200]"
              style={inputStyle}
            ...
            <div className="flex flex-wrap gap-3">
              {amenities.map((checked, i) => (
                <label
                  ...
                  style={{
                    borderColor: checked ? "#A53200" : "#F2F2F2",
                    backgroundColor: checked ? "#FFF0E6" : "#FAFAFA",
                  }}
                >
                  <Checkbox
                    checked={checked}
                    ...
                    className="border-[#A53200] data-[state=checked]:bg-[#A53200] data-[state=checked]:border-[#A53200]"
                  />
                  <span className="text-sm font-medium" style={{ color: checked ? "#A53200" : "#6C757D" }}>
                    Floor
                  </span>
                </label>
              ))}
        ...
        <Section title="Media Upload" delay={0.2}>
          <div className="flex flex-col gap-1.5">
            ...
            <div
              ...
              style={{
                borderColor: dragOver ? "#A53200" : "#E5E7EB",
                backgroundColor: dragOver ? "#FFF0E6" : "#FAFAFA",
              }}
            >
              {preview ? (
                ...
                <>
                  <CloudUpload className="w-10 h-10" style={{ color: "#A53200" }} />
      ...
      <div className="flex items-center justify-end gap-3 p-6 px-8shrink-0">
        ...
        <Button
          ...
          style={{ backgroundColor: "#A53200", color: "#FFFFFF" }}
        >
          Add a New Listing
        </Button>
      </div>
