      ...
      <div className=" bg-white p-4 sm:p-5 space-y-6 sm:space-y-7 rounded-lg shadow-sm border border-white/50">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="w-12 h-12 flex items-center justify-center rounded-sm hover:bg-gray-200 transition-colors shadow-sm border boder-white cursor-pointer">
            <Eye className="w-5 h-5 text-[#A53200]" />
          </button>
        </div>
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <textarea
              ...
              className="w-full h-32 sm:h-40 p-4 sm:p-8 bg-[#FFFAF5] rounded-lg text-sm sm:text-base font-normal text-gray-700 leading-relaxed border border-orange-50/50 focus:ring-1 focus:ring-[#A53200]/20 shadow-sm outline-none resize-none placeholder:text-gray-400"
            />
          </div>

          <button className="w-full sm:w-auto px-10 sm:px-14 py-3 bg-[#A53200] text-white rounded-lg cursor-pointer font-medium text-base sm:text-lg shadow-lg shadow-orange-100 hover:bg-[#0085C4] transition-all active:scale-95">
            Send Reply
          </button>
        </div>
      </div>
          ...
          {[1, 2, "...", 10].map((page, i) => (
            <button
              ...
              className={cn(
                ...
                page === 1 ? "bg-[#A53200] text-white shadow-md shadow-orange-100" : "bg-white text-gray-600 border border-gray-100 shadow-sm"
              )}
            >
              {page}
            </button>
