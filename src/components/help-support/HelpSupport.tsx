                  ...
                  <div key={req.id} className="grid grid-cols-12 py-8 items-center group relative">
                    ...
                    <div className="col-span-2 whitespace-nowrap">
                      <div className={cn(
                        ...
                        req.status === "Solved" ? "bg-[#D1F7EA] text-[#10B981]" : "bg-[#FDE6D2] text-[#A53200]"
                      )}>
                        {req.status}
                      </div>
                    </div>
                        ...
                        {menuOpenId === req.id && (
                          <>
                            ...
                            >
                              ...
                              >
                                <Eye className="w-4 h-4 text-gray-400 group-hover/item:text-[#A53200]" />
                                View Request
                              </Link>
          ...
          {[1, 2, 3, 4, 5, 6, "...", 10].map((page, i) => (
            <button
              ...
              className={cn(
                ...
                page === 1 ? "bg-[#A53200] text-white cursor-pointer shadow-orange-100" : "bg-white/50 text-gray-600 cursor-pointer hover:bg-white border border-gray-100"
              )}
            >
              {page}
            </button>
          ...
          {[1, 2, "...", 10].map((page, i) => (
            <button
              ...
              className={cn(
                ...
                page === 1 ? "bg-[#A53200] text-white shadow-md shadow-orange-100" : "bg-white/50 text-gray-600 border border-gray-100"
              )}
            >
              {page}
            </button>
