        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <textarea
              ...
              className="w-full h-40 p-8 bg-[#FFFAF5] rounded-sm text-base font-normal text-gray-700 leading-relaxed border border-white focus:ring-1 focus:ring-[#A53200]/20 outline-none resize-none placeholder:text-gray-400"
            />
          </div>

          <div className="flex justify-end">
            <button className="px-14 py-3 bg-[#A53200] text-white rounded-lg font-normal cursor-pointer text-lg shadow-lg shadow-orange-100 hover:bg-[#0085C4] transition-all active:scale-95">
              Send Reply
            </button>
          </div>
        </div>
