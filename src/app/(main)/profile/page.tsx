        ...
        <section className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-8 border border-gray-100 space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-11 sm:pl-12 h-12 sm:h-14 bg-gray-50/30 border-gray-100 rounded-lg sm:rounded-xl text-sm sm:text-base focus:bg-white transition-all ${errors.firstName ? "border-red-500 ring-1 ring-red-500" : "focus:ring-[#A53200]/20 focus:border-[#A53200]/30"
                    }`}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-11 sm:pl-12 h-12 sm:h-14 bg-gray-50/30 border-gray-100 rounded-lg sm:rounded-xl text-sm sm:text-base focus:bg-white transition-all ${errors.lastName ? "border-red-500 ring-1 ring-red-500" : "focus:ring-[#A53200]/20 focus:border-[#A53200]/30"
                    }`}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-11 sm:pl-12 h-12 sm:h-14 bg-gray-50/30 border-gray-100 rounded-lg sm:rounded-xl text-sm sm:text-base focus:bg-white transition-all ${errors.email ? "border-red-500 ring-1 ring-red-500" : "focus:ring-[#A53200]/20 focus:border-[#A53200]/30"
                    }`}
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`pl-11 sm:pl-12 h-12 sm:h-14 bg-gray-50/30 border-gray-100 rounded-lg sm:rounded-xl text-sm sm:text-base focus:bg-white transition-all ${errors.phone ? "border-red-500 ring-1 ring-red-500" : "focus:ring-[#A53200]/20 focus:border-[#A53200]/30"
                    }`}
                />
              </div>
          ...
          <div className="flex justify-end pt-2">
            <button
              ...
              className="w-full sm:w-auto bg-[#A53200] hover:bg-[#E64200] text-white px-8 sm:px-10 h-11 sm:h-12 rounded-lg text-sm sm:text-base font-semibold shadow-lg shadow-orange-100 transition-all active:scale-95 flex items-center justify-center gap-2 cursor-pointer"
            >
              Update Profile
            </button>
          </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-11 sm:pl-12 pr-12 h-12 sm:h-14 bg-gray-50/30 border-gray-100 rounded-lg sm:rounded-xl text-sm sm:text-base focus:bg-white transition-all ${errors.oldPassword ? "border-red-500 ring-1 ring-red-500" : "focus:ring-[#A53200]/20 focus:border-[#A53200]/30"
                      }`}
                  />
                  <button
                    type="button"
