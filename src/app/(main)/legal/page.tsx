                    ...
                    >
                        ...
                        {activeTab === "terms" && (
                            <motion.div
                                ...
                                className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#A53200] rounded-t-full"
                            />
                        )}
                    </button>
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className="flex items-start gap-3 bg-[#FFF8F0] border border-orange-100 rounded-lg sm:rounded-xl px-4 sm:px-5 py-3 sm:py-3.5">
                            <AlertCircle className="w-5 h-5 text-[#A53200] mt-0.5 shrink-0" />
                            <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                                ...
                                <span className="font-semibold text-[#A53200]">Plain Text</span> mode.
                            </p>
                        </div>
                        ...
                        <textarea
                            ...
                            rows={12}
                            spellCheck={false}
                            className="w-full bg-[#FAFAFA] rounded-xl border border-gray-100 p-4 sm:p-6 font-mono text-xs sm:text-sm text-gray-700 leading-relaxed resize-none focus:outline-none focus:ring-2 focus:ring-[#A53200]/10 focus:border-[#A53200]/20 transition-all placeholder:text-gray-400"
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
                            ...
                            <button
                                onClick={handleSave}
                                className="w-full sm:w-auto bg-[#A53200] hover:bg-[#0085C4] text-white px-12 sm:px-16 h-10 sm:h-12 rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold shadow-lg shadow-orange-100 transition-all active:scale-95 order-1 sm:order-2"
                            >
                                Save Changes
                            </button>
                        </div>
